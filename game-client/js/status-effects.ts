...
export const statusEffectsAPI = {
    async getCharacterEffects(characterId: number) {
        try {
...
export function createEffectBadge(effect: StatusEffect): string {
...
export function renderActiveEffects(containerId: string, effects: StatusEffect[]) {
